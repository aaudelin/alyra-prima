        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{"name":"Prima Invoice ', invoice.id, '", "description":"Invoices generated by Prima", ',
                            '"attributes":[{"trait_type":"Id","value":"', invoice.id, '"}, ',
                            '{"trait_type":"Activity","value":"', invoice.activity, '"}, ',
                            '{"trait_type":"Country","value":"', invoice.country, '"}, ',
                            '{"trait_type":"Due Date","value":"', Strings.toString(invoice.dueDate), '"}, ',
                            '{"trait_type":"Amount","value":"', Strings.toString(invoice.amount), '"}, ',
                            '{"trait_type":"Amount To Pay","value":"', Strings.toString(invoice.amountToPay), '"}], ',
                            '"image":"', _getSVG(), '"}'
                        )
                    )
                )
